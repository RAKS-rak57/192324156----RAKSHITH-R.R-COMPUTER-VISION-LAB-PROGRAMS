...
class ErosionApp:
    def __init__(self, root):
        ...
        self.kernel_size = ttk.Scale(root, from_=1, to=21, value=3, command=self.update_erosion)
        self.kernel_size.pack()
        
        ttk.Label(root, text="Iterations:").pack()
        self.iterations = ttk.Scale(root, from_=1, to=10, value=1, command=self.update_erosion)
    ...
    def update_erosion(self, event=None):
        ...
        eroded = cv2.erode(self.gray_img, kernel, iterations=iterations)
